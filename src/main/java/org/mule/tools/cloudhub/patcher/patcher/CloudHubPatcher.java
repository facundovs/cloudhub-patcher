...
import org.mule.tools.cloudhub.patcher.pom.PomModifier;
import org.mule.tools.cloudhub.patcher.pom.PomModifier.PomModifierException;
...
public class CloudHubPatcher
{
    ...
    public void patch (String branchName, String commitMessage, String groupId, List<SupportEscalationArtifact> seArtifacts) throws GitHubClientException, PomModifierException
    {
        ...
        pomModifier.addArtifactItems(repository.getPath() + "/" + CLOUDHUB_RELATIVE_POM_LOCATION, POM_NEAR_ELEMENT, groupId, seArtifacts, POM_ARTIFACT_TYPE,  Integer.parseInt(POM_TABS));
